    ...
    return (
        <section id="three">
            <div className="row">
                ...
                <div className="lg-col-4 md-col-12"><img className="bordered" src={dreamFanArt} alt="" /></div>
                <div className="lg-col-8 md-col-12 text">
                ...
                <div className="col-12">
                    <h2 class="title">CREATING &amp; GROWING A TRULY INCLUSIVE COMMUNITY</h2>
                </div>          
            </div>
